...
class FreecadPropertiesHelper:
    ...
    def migrate(self, obj: App.DocumentObject):
        for prop in self.properties:
            prop.migrate(obj)
        # Ensure properties are visible/editable by default in the property editor.
        # Setting editor mode to 0 makes them editable. If you want selected
        # properties read-only, handle individually later.
        for prop in obj.PropertiesList:
