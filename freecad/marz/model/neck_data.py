...
class NeckData(object):
    ...
    # ! cache entry.
    __slots__ = ['fbd', 'thicknessSlope', 'startThickness', 'chunk_props', '_ihash']
    ...
    def __init__(self, inst, fbd):
        ...
        chunk_props = (getattr(inst.fretboard, 'length', 0.0), inst.neck.extraChunkLength, inst.neck.extraChunkVerticalOffset, inst.neck.extraChunkDepthOffset, inst.neck.extraChunkThickness, inst.neck.extraChunkVerticalThickness)
        super().__setattr__('chunk_props', chunk_props)

        # Calculate immutable hash
        ihash = hash((thicknessSlope, startThickness, fbd, chunk_props))
    ...
    def __eq__(self, other):
        return (self.thicknessSlope == other.thicknessSlope
                ...
                and self.chunk_props == other.chunk_props)
