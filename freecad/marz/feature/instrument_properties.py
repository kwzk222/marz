...
properties = [
    ...
    fcp('neck.profile',                 "Parametric", 'Neck profile section', options=lambda: ["Parametric"], compat=COMPAT_PRE_028),
    fcp('neck.coreWidthRatio',          0.5, 'Width of flat core relative to neck width', compat=COMPAT_PRE_028),
    fcp('neck.coreThicknessRatio',      0.0, 'Height of core relative to neck thickness', compat=COMPAT_PRE_028),
    fcp('neck.coreOffsetRatio',         0.0, 'Horizontal offset of core', compat=COMPAT_PRE_028),
    fcp('neck.radiusTreble',            50.0, 'Radius of treble transition arc', compat=COMPAT_PRE_028),
    fcp('neck.radiusBass',              50.0, 'Radius of bass transition arc', compat=COMPAT_PRE_028),
    fcp('neck.useGordonSurface',        False, 'Use Gordon surface for neck (EXPERIMENTAL: disable if it crashes your PC)', ui='App::PropertyBool', compat=COMPAT_PRE_028),
