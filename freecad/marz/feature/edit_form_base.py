...
class InstrumentFormBase:
    ...
    neck_extraChunkLength: ValueInput = None  # float (100.0)
    neck_extraChunkVerticalOffset: ValueInput = None  # float (0.0)
    neck_extraChunkDepthOffset: ValueInput = None  # float (0.0)
    neck_extraChunkThickness: ValueInput = None  # float (15.0)
    neck_extraChunkVerticalThickness: ValueInput = None  # float (30.0)
    ...
    fretboard_isZeroFret: ValueInput = None  # bool (False)
    fretboard_EDO: ValueInput = None  # int (12)
    fretboard_length: ValueInput = None  # float (0.0)
